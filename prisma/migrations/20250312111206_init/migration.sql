...
CREATE TABLE `Service` (
    ...
    INDEX `Service_description_idx`(`description`(768)),
    INDEX `Service_clickCount_idx`(`clickCount`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `ServiceTag` (
    ...
    INDEX `ServiceTag_serviceId_idx`(`serviceId`),
    INDEX `ServiceTag_tagId_idx`(`tagId`),
